...
surveysRouter.post(
  "/pre/is-answer",
  surveysController.isParticipantAnsweredPre
);
surveysRouter.post(
  "/post/is-answer",
  surveysController.isParticipantAnsweredPost
);
surveysRouter.get(
  "/:id/participants-answers",
  surveysController.getSurveyStatsForParticipants
);
