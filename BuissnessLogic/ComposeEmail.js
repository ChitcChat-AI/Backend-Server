                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td style="text-align: center;">
                                <img src="https://i.ibb.co/0qNjJ5j/logo.png" alt="logo" >
                            </td>
                        </tr>
                    </table>
                </td>
                        ...
                        <tr>
                            <td style="text-align: center;">
                                <div class="text-author">
                                    <h3 class="name">Experiment subject: </h3>
                                    <span class="position">${expSubject}</span>
                                    <p><a href="${expLink}" class="btn btn-primary">Join Experiment</a></p>
                                </div>
                            </td>
                        </tr>
                    </table>
